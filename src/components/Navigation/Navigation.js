      ...
      <section className={`navigation ${props.isOpen ? "navigation_opened" : ""}`}>
          <div className="navigation__wrapper">
              ...
              <nav className="navigation__elems">
                  ...
                  <NavLink to="/movies" onClick={navClose} className="navigation__elem" activeClassName="navigation__elem-active">Фильмы</NavLink>
                  <NavLink to="/saved-movies" onClick={navClose} className="navigation__elem" activeClassName="navigation__elem-active">Сохранённые фильмы</NavLink>
                  <div className="navigation__elem-profileWrapper">
                    <NavLink to="/profile" onClick={navClose} className="navigation__elem navigation__elem-profile" activeClassName="navigation__elem-active">Аккаунт</NavLink>
